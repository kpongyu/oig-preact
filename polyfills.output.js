! function(e) {
        ...
        ! function(t) {
            ...
            function i(e, t) {
                ...
                e._handled = !0, r._immediateFn(function() {
                    ...
                    if (null === n) return void(1 === e._state ? u : s)(t.promise, e._value);
                    var o;
                    try {
                        o = n(e._value)
                    } catch (e) {
                    ...
                    function o(e, u) {
                        try {
                            if (u && ("object" == typeof u || "function" == typeof u)) {
                                var s = u.then;
                                if ("function" == typeof s) return void s.call(u, function(t) {
                                    o(e, t)
                                }, n)
                            }
                            r[e] = u, 0 == --i && t(r)
    ...
    QAmr: function(e, t) {
        "use strict";
        t.__esModule = !0, t.default = "function" == typeof fetch ? fetch.bind() : function(e, t) {
            return t = t || {}, new Promise(function(n, o) {
                function r() {
                    var e, t = [],
                        n = [],
                        o = {};
                    return i.getAllResponseHeaders().replace(/^(.*?):\s*([\s\S]*?)$/gm, function(r, i, u) {
                        t.push(i = i.toLowerCase()), n.push([i, u]), e = o[i], o[i] = e ? e + "," + u : u
                    }), {
                        ok: 1 == (i.status / 200 | 0),
                        status: i.status,
...
//# sourceMappingURL=polyfills.11f1b.js.map